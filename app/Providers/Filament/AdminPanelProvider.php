        ...
        return $panel
            ...
            ->bootUsing(function (Panel $panel): void {
                \Filament\Support\Facades\FilamentView::registerRenderHook(
                    ...
                    fn (): string => Blade::render('<div class="mb-6" style="text-align:center"><img src="/img/logo_tens2.jpg" alt="Tens Coffee" style="height:4rem;width:auto;display:block;margin:0 auto 0.5rem"><h1 class="text-2xl font-bold text-gray-900" style="text-align:center">Selamat Datang</h1><p class="text-sm text-gray-500" style="text-align:center">Panel Admin Tens Coffee</p></div>'),
                );
            });
    }
}
