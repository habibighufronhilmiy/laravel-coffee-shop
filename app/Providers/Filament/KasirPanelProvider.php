        ...
        return $panel
            ...
            ->bootUsing(function (Panel $panel): void {
                \Filament\Support\Facades\FilamentView::registerRenderHook(
                    ...
                    fn (): string => Blade::render('<div class="text-center mb-6"><img src="/img/logo_tens2.jpg" alt="Tens Coffee" class="h-16 w-auto mx-auto mb-2"><h1 class="text-2xl font-bold text-gray-900">Selamat Datang</h1><p class="text-sm text-gray-500">Panel Kasir Tens Coffee</p></div>'),
                );
            });
    }
}
